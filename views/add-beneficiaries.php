<div class="container">
		<div class="nav">
			...
			<ul class="nav-list">
				...
				<li class="list-items active"><a href="add-beneficiaries.php">Add Beneficiaries</a></li>
			</ul>
		...
		<div>
			...
			<form class="inner-main-profile" method="POST">
			...
			?>
				<?php echo display_error($validation_errors, 'beneficiaries'); ?>
				<p>
					<label>Enter beneficiary account number</label><br>
					<input type="text" name="beneficiaries">
				</p><br><br>
				
				<input type="hidden" name="csrf_token" value="<?php echo csrf_token(); ?>">
				<p>
					<input class="submit-button" type="submit" name="submit" value="Add Beneficiary">
				</p>
